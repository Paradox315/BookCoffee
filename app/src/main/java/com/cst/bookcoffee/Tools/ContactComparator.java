...
public class ContactComparator  implements Comparator<UserStruct> {

    @Override
    public int compare(UserStruct u1, UserStruct u2) {
        String o1=u1.getPinyin();
        String o2=u2.getPinyin();
